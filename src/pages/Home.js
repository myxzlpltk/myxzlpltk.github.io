      ...
      <div className="flex flex-wrap items-center">
        <div className="hidden md:block basis-2/6">
          <div className="fade-image">
            <img src="/images/avatar.png" alt="Avatar Meta" className="w-100 animate__animated animate__fadeInUp" />
          </div>
        ...
        <div className="basis-full md:basis-4/6 md:pl-10 lg:pl-20">
          ...
          <div className="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start animate__animated animate__slideInUp">
