		...
		<main className="container py-12 md:py-16 lg:py-20 grid grid-cols-none md:grid-cols-3 items-center md:gap-10 lg:gap-20" id="about-me">
			...
			<div className="md:col-span-2">
				...
				<div className="sm:flex sm:justify-center lg:justify-start">
					<PingNotification>
						<ElevatedButton external to="//docs.google.com/document/d/1xLH3Dk8vcmizpPnb9Z0KvpRQFQuP8rbjqpbbZjcJFfM/view?usp=sharing">
							...
							<div className="relative inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
								...
								<div className="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
									{project.buttons.map((button, i) => (
										<ElevatedButton key={`button-project-${i}`} compact to={`//${button.link}`} className="inline-block mx-2">
											{button.title}
										</ElevatedButton>
									))}
								</div>
