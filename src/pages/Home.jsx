		...
		<main className="container py-12 md:py-16 lg:py-20 grid grid-cols-none md:grid-cols-3 items-center md:gap-10 lg:gap-20">
			<div className="hidden md:block">
				...
				<Text caption className="text-center">
					Auto Generated by&nbsp;
					<a href="https://readyplayer.me" className="text-blue-600">
						Ready Player Me
					</a>
				</Text>
			</div>
		...
		<Fragment>
			...
			<section className="bg-indigo-700">
				<div className="container py-6 md:py-8 lg:py-10">
					<div className="flex gap-4 items-center p-16 max-w-5xl mx-auto bg-indigo-900 rounded-lg -mt-24 mb-16 text-white shadow-md">
