...
function Text(props) {
	if (props.headline1) {
		return (
			<h1 className={classNames(props.className, 'text-7xl font-spaceMono font-extrabold tracking-tighter')}>
				{props.children}
			</h1>
		);
	} else if (props.headline2) {
		return (
			<h2 className={classNames(props.className, 'text-5xl font-spaceMono font-extrabold tracking-tight')}>
				{props.children}
			</h2>
		);
	} else if (props.headline3) {
		return (
			<h3 className={classNames(props.className, 'text-4xl font-spaceMono font-bold tracking-normal')}>
				{props.children}
			</h3>
		);
	} else if (props.headline4) {
		return (
			<h4 className={classNames(props.className, 'text-3xl font-spaceMono font-bold tracking-wide')}>
				{props.children}
			</h4>
		);
	} else if (props.headline5) {
		return (
			<h5 className={classNames(props.className, 'text-2xl font-spaceMono font-bold tracking-normal')}>
				{props.children}
			</h5>
		);
	} else if (props.headline6) {
		return (
			<h6 className={classNames(props.className, 'text-lg font-spaceMono font-bold tracking-wide')}>
				{props.children}
			</h6>
		);
		...
		return (
			<p
				className={classNames(
					props.className,
					'text-sm md:text-base font-sourceCodePro font-medium tracking-tighter'
				)}
			>
				{props.children}
			</p>
